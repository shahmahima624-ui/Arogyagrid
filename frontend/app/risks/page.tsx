...
export default function RisksPage() {
 ...
 case "CRITICAL":
 return (
 <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-black bg-white text-rose-600 border border-rose-600 animate-pulse">
 🚨 CRITICAL ({timeLabel})
 </span>
 );
 case "HIGH_RISK":
 return (
 <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold bg-white text-amber-600 border border-amber-600">
 ⚠️ HIGH RISK ({timeLabel})
 </span>
 );
 case "AT_RISK":
 return (
 <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-white text-blue-600 border border-blue-600">
 ⏳ AT RISK ({timeLabel})
 </span>
 );
 default:
 return (
 <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-white text-emerald-600 border border-emerald-700">
 ✓ HEALTHY ({timeLabel})
 </span>
 );
 }
 ...
 className="inline-flex items-center gap-2 rounded-lg bg-teal-600 hover:bg-teal-700 text-white font-bold px-4 py-2 text-xs font-semibold shadow-xs transition-all disabled:opacity-50"
 >
 ...
 <span>1.0 day</span>
 <span className="font-bold text-rose-600">{criticalThreshold} days</span>
 <span>5.0 days</span>
 </div>
 </div>
 ...
 <div className="flex justify-between text-[11px] text-slate-500 mt-1">
 <span>3.0 days</span>
 <span className="font-bold text-amber-600">{highRiskThreshold} days</span>
 <span>10.0 days</span>
 </div>
 </div>
 ...
 <div className="flex justify-between text-[11px] text-slate-500 mt-1">
 <span>7.0 days</span>
 <span className="font-bold text-blue-600">{atRiskThreshold} days</span>
 <span>21.0 days</span>
 </div>
 </div>
 </div>
 ...
 <p className="mt-1 text-[11px] text-slate-500 font-medium">Immediate transfer needed</p>
 </div>
 ...
 <p className="mt-1 text-[11px] text-slate-500 font-medium">Reorder within 48h</p>
 </div>
 ...
 <p className="mt-1 text-[11px] text-slate-500 font-medium">Monitor dispensing velocity</p>
 </div>
 ...
 <p className="mt-1 text-[11px] text-slate-500 font-medium">Buffer adequate</p>
 </div>

 <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm col-span-2 lg:col-span-1">
 ...
 item.risk_level === "CRITICAL" ? "bg-white" : ""
 }`}
 >
 ...
 <span className={`font-bold ${item.current_usable_stock === 0 ? "text-rose-600 font-black" : "text-slate-700"}`}>
