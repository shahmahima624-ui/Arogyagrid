      ...
      <main className="min-h-screen bg-white text-slate-900 pb-16">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 backdrop-blur space-y-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-slate-50 p-6 backdrop-blur space-y-6">
