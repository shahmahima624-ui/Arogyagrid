        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-6 space-y-8">
          ...
          {result && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="rounded-2xl border border-rose-800 bg-rose-950/40 p-5 backdrop-blur">
              ...
              <div className="rounded-2xl border border-amber-800 bg-amber-950/40 p-5 backdrop-blur">
              ...
              <div className="rounded-2xl border border-purple-800 bg-purple-950/40 p-5 backdrop-blur">
                  ...
                  <div key={i} className="space-y-1">
                    <div className="flex justify-between text-xs font-mono font-bold text-slate-600">
                      ...
                      <span>
                        ...
                        <span className="text-rose-400">{c.simulated_stock}</span> (Gap: {c.gap})
                      </span>
                    </div>
          ...
          {result && result.preventive_transfers.length > 0 && (
            <section className="rounded-2xl border border-emerald-800 bg-emerald-950/30 p-6 backdrop-blur space-y-4">
                ...
                {result.preventive_transfers.map((t, idx) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <span className="px-3 py-1 rounded-lg bg-emerald-900 text-emerald-200 font-mono font-extrabold text-sm block">
