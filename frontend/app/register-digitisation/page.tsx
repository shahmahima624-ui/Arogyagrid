...
const COLUMNS = [
 ...
 { key: "opening_stock", label: "Opening", type: "number", width: "min-w-[80px]", color: "text-blue-600" },
 { key: "received_stock", label: "Received", type: "number", width: "min-w-[80px]", color: "text-emerald-600" },
 { key: "consumed_stock", label: "Consumed", type: "number", width: "min-w-[80px]", color: "text-rose-600" },
 { key: "closing_stock", label: "Closing", type: "number", width: "min-w-[80px]", color: "text-amber-600" },
 { key: "expiry_date", label: "Expiry", type: "text", width: "min-w-[110px]", color: "text-purple-600" },
];
...
export default function RegisterDigitisationPage() {
 ...
 <ScanLine className="h-7 w-7 text-amber-600" />
 ...
 <div className="rounded-xl bg-white border border-emerald-700 px-4 py-3 text-sm text-emerald-600 font-bold flex items-center gap-2">
 ...
 className="w-full px-4 py-3 rounded-xl border border-amber-700 bg-white hover:bg-white text-amber-600 font-bold text-sm transition-all flex items-center justify-center gap-2"
 >
 ...
 {/* Right: Image Preview */}
 <div className="rounded-xl overflow-hidden border border-slate-200 bg-white min-h-[240px] flex items-center justify-center">
 {previewUrl ? (
 ...
 {rows.length > 0 && (
 <section className="rounded-2xl border border-slate-200 bg-white p-6 space-y-4 shadow-xl">
 ...
 {modelUsed && (
 <span className="text-xs font-mono text-amber-600 bg-white px-3 py-1 rounded-md border border-slate-200 shrink-0">
 Engine: {modelUsed}
 </span>
 )}
 </div>
