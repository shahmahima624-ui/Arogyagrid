        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          ...
          <div className="mb-6 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {activeTab === "opportunities" ? (
                <div className="flex items-center gap-1 bg-slate-900 p-1 rounded-lg border border-slate-200 text-xs">
            ...
            <div className="space-y-4">
              {filteredOpportunities.length === 0 ? (
                ...
                filteredOpportunities.map((opp) => (
                  <div
                    key={opp.batch_id}
                    className="p-5 rounded-2xl border border-purple-900/60 bg-white backdrop-blur hover:border-purple-600/80 transition-all shadow-xs"
                  >
