...
const COLOR_STYLES: Record<string, { bg: string; text: string; dot: string; border: string }> = {
  green:  { bg: "bg-emerald-950/60",  text: "text-emerald-300",  dot: "bg-emerald-400",  border: "border-emerald-700" },
  yellow: { bg: "bg-amber-950/60",    text: "text-amber-300",    dot: "bg-amber-400",    border: "border-amber-700" },
  orange: { bg: "bg-orange-950/60",   text: "text-orange-300",   dot: "bg-orange-500",   border: "border-orange-700" },
  red:    { bg: "bg-rose-950/60",     text: "text-rose-300",     dot: "bg-rose-500",     border: "border-rose-700" },
  purple: { bg: "bg-purple-950/60",   text: "text-purple-300",   dot: "bg-purple-500",   border: "border-purple-700" },
};
                ...
                <div className={`rounded-2xl border ${COLOR_STYLES[selected.risk_color]?.border ?? "border-slate-700"} ${COLOR_STYLES[selected.risk_color]?.bg ?? "bg-slate-800/40"} p-4 backdrop-blur`}>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    ...
                    <div className="bg-rose-950/40 rounded-lg p-2.5 border border-rose-900">
                      <div className="text-rose-300 font-medium flex items-center gap-1">
                    ...
                    <div className="bg-amber-950/40 rounded-lg p-2.5 border border-amber-900">
