        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          ...
          <section className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="rounded-2xl border border-purple-900/50 bg-purple-950/20 p-5 backdrop-blur shadow-sm ring-1 ring-purple-500/20">
              ...
              <p className="mt-1 text-xs text-purple-300/80">Mean Absolute % Error on Test Split</p>
            </div>

            <div className="rounded-2xl border border-amber-900/50 bg-amber-950/20 p-5 backdrop-blur shadow-sm ring-1 ring-amber-500/20">
              ...
              <p className="mt-1 text-xs text-amber-300/80">Active Time-Series Models</p>
            </div>
          </section>
              ...
              <div className="lg:col-span-3 bg-slate-50/80 rounded-2xl border border-slate-200/80 p-5">
                <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-xs">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-cyan-300 font-medium">ML Forecast</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                ...
                {detailLoading ? (
                  <div className="h-[300px] flex items-center justify-center text-slate-500 text-sm">
                    <RefreshCw className="h-5 w-5 animate-spin mr-2 text-cyan-400" /> Computing model forecast...
                  </div>
                ) : chartData ? (
