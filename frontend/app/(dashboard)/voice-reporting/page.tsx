...
export default function VoiceReportingPage() {
 ...
 Frontline Voice Inventory Reporting
 </p>
 </div>
 ...
 <span className="text-xs font-mono text-slate-500 bg-white px-2.5 py-1 rounded-md border border-slate-200">
 ...
 className="px-3 py-1.5 rounded-xl bg-white hover:bg-slate-100 border border-slate-200 text-xs text-slate-600 font-medium transition-all text-left"
 >
 <span className="text-emerald-600 font-bold mr-1">{p.label}:</span>
 &quot;{p.text}&quot;
 </button>
 ))}
 </div>
 ...
 <section className="rounded-2xl border border-slate-200 bg-white p-6 space-y-6 shadow-xl">
 ...
 {modelUsed && (
 <span className="text-xs font-mono text-purple-600 bg-white px-3 py-1 rounded-md border border-slate-200">
 Engine: {modelUsed}
 </span>
 )}
 </div>
 ...
 <div
 key={idx}
 className="p-4 rounded-xl border border-slate-200 bg-white grid grid-cols-1 md:grid-cols-4 gap-4 items-center"
 >
 <div>
 ...
 className="w-full bg-slate-100 border border-slate-200 rounded-lg px-3 py-2 text-sm font-mono text-emerald-600 font-bold"
 />
 </div>
 ...
 className="w-full bg-slate-100 border border-slate-200 rounded-lg px-3 py-2 text-sm font-mono text-purple-600 font-bold"
 />
 </div>
